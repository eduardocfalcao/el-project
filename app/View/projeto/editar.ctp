...
<?php echo $this->Form->create('Projeto',
    ...
    <div class="lar-02">
        <label for="responsavel">&bull; Responsável:</label><br />
         ...
         <?php echo $this->Form->input('responsavel', array("class" => "validate[required]")); ?>
    </div>

    <div class="lar-16 margem-01">
        <label for="cpf">&bull; Equipe que integrou o projeto e atribuições:</label><br />

         <?php echo $this->Form->input('equipe', array('rows' => '5', 'cols' => '10', "class" => "validate[required]")); ?>
    </div>
	...
	<div class="lar-16 margem-01">
        <label for="criancasEnvolvidas">&bull;Crianças envolvidas:</label><br />
         ...
         <?php echo $this->Form->input('criancasEnvolvidas', array('rows' => '5', 'cols' => '10', "class" => "validate[required]")); ?>
    </div>
    
    <div class="lar-16 margem-01">
        <label for="objetivos">&bull;Objetivos:</label><br />

         <?php echo $this->Form->input('objetivos', array('rows' => '5', 'cols' => '10', "class" => "validate[required]")); ?>
    </div>	
    
      <div class="lar-16 margem-01">
        <label for="justificativa">&bull;Justificativa:</label><br />

         <?php echo $this->Form->input('justificativa', array('rows' => '5', 'cols' => '10', "class" => "validate[required]")); ?>
    </div>	
    
    <div class="lar-16 margem-01">
        <label for="metodologia">&bull;Metodologia:</label><br />

         <?php echo $this->Form->input('metodologia', array('rows' => '5', 'cols' => '10', "class" => "validate[required]")); ?>
    </div>	
    
    <div class="lar-16 margem-01">
        <label for="atividades">&bull;Atividades:</label><br />

         <?php echo $this->Form->input('atividades', array('rows' => '5', 'cols' => '10', "class" => "validate[required]")); ?>
    </div>		
    
    <div class="lar-16 margem-01">
        <label for="resultados">&bull;Resultados:</label><br />

         <?php echo $this->Form->input('resultados', array('rows' => '5', 'cols' => '10', "class" => "validate[required]")); ?>
    </div>		
    
    <div class="lar-16 margem-01">
        <label for="planoUtilizacaoRecurso">&bull;Plano de reutilização do recurso:</label><br />

         <?php echo $this->Form->input('planoUtilizacaoRecurso', array('rows' => '5', 'cols' => '10', "class" => "validate[required]")); ?>
    </div>			
