<?php echo $this->assign('background',"bg-parceiros"); ?>
...
<div class="container" style="overflow:hidden;">
	...
	<br/></p>
	<p><a href="http://www.cecip.org.br/" target: _blank><strong>VISITE O SITE</strong></a>
	</p>

</div>

<div class="line02" style="width: 100%;margin: 50px 0;"></div>
  
  
<div class="container">  

<h5 style="font-size: 22px;margin-bottom: 50px;">APOIO</h5>

<div class="box10 margem-03">


<?php echo $this->Html->image('vanleer.png', array('style' => 'display: block;margin: 0 auto; width: 115px;')); ?>
...
<p>O Instituto C&A é dedicado a promover e qualificar o processo de educação de crianças e adolescentes no Brasil por meio do desenvolvimento de parcerias com outras organizações sociais e com o poder público. 
<br/>
<a href="http://www.institutocea.org.br/" target: _blank>VISITE O SITE</a></p>
...
<p>Apoio
O prêmio conta ainda com o apoio da Rede Nacional Primeira Infância (RNPI), formada por organizações de diversos setores que atuam na promoção e defesa dos direitos da primeira infância. 
<br/>
