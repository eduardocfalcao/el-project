...
<?php echo $this->Form->create('Documentos',
	...
	<div class="lar-01">
        ...
        <div class="lar-07"><?php echo $this->Form->file('documentoEstatuto'); ?></div>
    </div>
   ...
   <div class="lar-01">
        ...
        <div class="lar-07"><?php echo $this->Form->file('documentoAssembleia'); ?></div>
   </div>
    
    <div class="lar-01">
        <label for="documentoContratoSocial">Cópia do Contrato Social:</label><br />

        <div class="lar-07"><?php echo $this->Form->file('documentoContratoSocial'); ?></div>
    </div>
    ...
    <div class="lar-01">
        ...
        <div class="lar-07"><?php echo $this->Form->file('documentoCnpj'); ?></div>
    </div>
    
     <div class="lar-01">
    	<label for="documentoCompovante">Cópia do comprovante de endereço da instituição (contas de água, luz, telefone):</label><br />
        <div class="lar-07"><?php echo $this->Form->file('documentoCompovanteEndereco'); ?></div>
    </div>
     ...
     <div class="lar-01">
        ...
        <div class="lar-07"><?php echo $this->Form->file('documentoResponsavelRg'); ?></div>
    </div>
    ...
    <div class="lar-01">
       ...
       <div class="lar-07"> <?php echo $this->Form->file('documentoResponsavelCpf'); ?></div>
    </div>
    ...
    <div class="lar-01">
       ...
       <div class="lar-07"> <?php echo $this->Form->file('documentoDeclaracao'); ?></div>
    </div>   
