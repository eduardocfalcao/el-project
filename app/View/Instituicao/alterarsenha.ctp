...
<?php echo $this->Form->create('Instituicao',
    ...
    <label for="senhaAtual">&bull; Senha Atual:</label>
   	...
   	<?php echo $this->Form->input('senhaAtual', array('type' => 'password', "class" => "validate[required]", "maxlength" => "150")); ?>
    </div>
    ...
    <?php echo $this->Form->input('repetirSenha', array('type' => 'password', "class" => "validate[required,equals[senha]]", "maxlength" => "150")); ?>
	</div>
