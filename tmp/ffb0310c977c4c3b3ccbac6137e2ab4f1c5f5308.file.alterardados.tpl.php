...
" type="text"   name="nome" id="nome" maxlength="1000">
        ...
        <div class="radius margem-03"><input type="radio" name="sexo" value="1" <?php if ($_smarty_tpl->tpl_vars['usuario']->value->getSexo()==1){?>checked<?php }?>> Masculino</div>
        
        <div class="radius margem-04"><input type="radio" name="sexo" value="2" <?php if ($_smarty_tpl->tpl_vars['usuario']->value->getSexo()==2){?>checked<?php }?>> Feminino</div>
		</div>
